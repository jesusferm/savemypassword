                ...
                <div class="grid condensed conten-descrip">
                    <div class="row cells5 ">
                        <div class="cell colspan3 bg-white">
                            <h1 class="text-light fg-blue"> Privacidad <span class="mif-security place-right"></span></h1>
                            <hr class="thin bg-grayLighter">
                            <div class="cell">
                                <h5 class="fg-darker">La privacidad es una utopía cuando se trata de internet, sin embargo, es posible cuando el servicio es sin fines de lucro. SaveMyPassword en son de la privacidad te ofrece:</h5>
                                <div class="row cells5">
                    ...
                    <footer>
                        ...
                        <div class="ali-der-menu span12">
                            <ul class="horizontal-menu compact">
                                ...
                                <li class="place-right"><a href="#"> <span class="mif-security"> Privacidad </span> </a></li>
