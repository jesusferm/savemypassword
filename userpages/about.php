    ...
    <body background="img/back2.jpg">
        ...
        <div class="container page-content">
            ...
            <div class="app-bar fixed-top darcula" data-role="appbar">
                <a href="../dashboard.php" class="app-bar-element branding"><span class="mif-home"> SaveMyPassword </span></a>
                <span class="app-bar-divider"></span>
                <ul class="app-bar-menu">
                    <li><a href="#" class="selected fg-white fg-hover-yellow"><span class="mif-help"></span> Acerca de</a></li>
                </ul>
            ...
            <div class="flex-grid" style="height: 100%;">
                <div class="row" style="height: 100%">
                    ...
                    <div class="cell auto-size padding20 bg-white">
                        <h1 class="text-light"> Acerca de SaveMyPassword <span class="mif-info place-right"></span></h1>
                        <hr class="thin bg-grayLighter ">
                            <div class="cell align-center">
                                ...
                                <h4 class="fg-green">Fue creado y desarrollado por <span>Fernando Merino</span>: Licenciado en Informática, interesado en
                                    ...
                                    Enviar sugerencias y bugs:<a href="mailto:linuxitos@gmail.com">LiNuXiToS</a>
                                </h4>
                                <div class="fg-darker align-center">
                                ...
                                <div class="fg-dark align-center text-small" style="margin-top:150px;">
