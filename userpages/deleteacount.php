                ...
                <div class="app-bar-element place-right">
                    ...
                    <div class="app-bar-drop-container padding10 place-right no-margin-top block-shadow" data-role="dropdown" data-no-close="true" style="width: 220px">
                        ...
                        <ul class="unstyled-list">
                            <li><a href="#" class="fg-white fg-hover-yellow"><span class="mif-security"></span> Securidad</a></li>
            ...
            <div class="flex-grid" style="height: 100%;">
                <div class="row" style="height: 100%">
                    ...
                    <div class="cell auto-size padding20 bg-white">
                        <h1 class="text-light fg-red"> Eliminar mi cuenta de SaveMyPassword <span class="mif-cancel place-right"></span></h1>
                        <hr class="thin bg-grayLighter">
                        <div class="grid">
                            <div class="row ">
                                <div class="cell colspan12 align-center ">
                                    <h4>Al eliminar tu cuenta de SaveMyPassword, también se eliminará toda información que hayas almacenado en nuestro sitio web.</h4>
                                    ...
                                    <div class="cell">
                                        ...
                                        <div class="input-control text ">
                                            <input type="submit" name="Submit" value="Eliminar mi cuenta" class="button bg-orange warning large primary">
                                        </div>
                                    </div>
                                </form>
                                </div>
