                                ...
                                <div class="row cells5">
                                    <div class="cell colspan5">
                                        ...
                                        <div class="input-control text full-size" data-role="input">
                                            ...
                                            <input id="descripcion" name="descripcion" type="text" placeholder="" data-validate-func="minlength" data-validate-arg="1" data-validate-hint-position="top">
                                            <span class="input-state-error mif-warning"></span>
                                        </div>
                                    </div>
                                </div>
                                <input type="reset" name="reset" value="Limpiar" class="button bg-gray button large primary">
                                <input type="submit" name="Submit" value="Guardar" class="button bg-pass button large primary">
                            </div>
                        </form>
                    </div>
                </div>
